...
const MaterialNew = require('./MaterialNew');
...
// RemainingFabric now relates to MaterialNew, not User/Order based on the new diagram
...
MaterialNew.hasMany(MaterialMovement, { foreignKey: 'materialId' });
MaterialMovement.belongsTo(MaterialNew, { foreignKey: 'materialId' });
...
MaterialNew.hasMany(ProductMaterial, { foreignKey: 'materialId' });
ProductMaterial.belongsTo(MaterialNew, { foreignKey: 'materialId' });
...
MaterialNew.hasMany(RemainingFabric, { foreignKey: 'materialId' });
RemainingFabric.belongsTo(MaterialNew, { foreignKey: 'materialId' });
...
MaterialNew.hasMany(Product, { foreignKey: 'materialId' });
Product.belongsTo(MaterialNew, { foreignKey: 'materialId' });
...
MaterialNew.hasMany(MaterialPurchaseAlert, { foreignKey: 'materialId', as: 'purchaseAlerts' });
MaterialPurchaseAlert.belongsTo(MaterialNew, { foreignKey: 'materialId' });
...
MaterialNew.hasMany(PurchaseLog, { foreignKey: 'materialId', as: 'purchaseLogs' });
PurchaseLog.belongsTo(MaterialNew, { foreignKey: 'materialId' });
