...
const getAdminSummary = asyncHandler(async (req, res) => {
    try {
        ...
        try {
            ...
            const outOfStockCount = await MaterialNew.count({
                where: {
                    qtyOnHand: 0
                }
            });
            ...
            const stockSummary = await MaterialNew.findOne({
                attributes: [
