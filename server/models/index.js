...
// NEW: Per-Product Progress Tracking Models
const ProductProgressReport = require('./ProductProgressReport');
const ProductProgressPhoto = require('./ProductProgressPhoto');
...
// NEW: Direct associations for better querying
...
// NEW: Individual Product Progress Report Relationships
Product.hasMany(ProgressReport, { foreignKey: 'productId', as: 'IndividualProgressReports' });
ProgressReport.belongsTo(Product, { foreignKey: 'productId' });

OrderProduct.hasMany(ProgressReport, { foreignKey: 'orderProductId', as: 'IndividualProgressReports' });
ProgressReport.belongsTo(OrderProduct, { foreignKey: 'orderProductId' });

// NEW: Per-Product Progress Report Relationships
ProgressReport.hasMany(ProductProgressReport, { foreignKey: 'progressReportId', as: 'ProductReports' });
ProductProgressReport.belongsTo(ProgressReport, { foreignKey: 'progressReportId' });

Product.hasMany(ProductProgressReport, { foreignKey: 'productId', as: 'ProgressReports' });
ProductProgressReport.belongsTo(Product, { foreignKey: 'productId' });

OrderProduct.hasMany(ProductProgressReport, { foreignKey: 'orderProductId', as: 'ProgressReports' });
ProductProgressReport.belongsTo(OrderProduct, { foreignKey: 'orderProductId' });

// NEW: Product Progress Photo Relationships
ProductProgressReport.hasMany(ProductProgressPhoto, { foreignKey: 'productProgressReportId', as: 'Photos' });
ProductProgressPhoto.belongsTo(ProductProgressReport, { foreignKey: 'productProgressReportId' });
